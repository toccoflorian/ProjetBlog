        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DisLikeId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ArticleReactions_DisLikes_DisLikeId",
                        column: x => x.DisLikeId,
                        principalTable: "DisLikes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ArticleReactions_Likes_LikeId",
                        column: x => x.LikeId,
                        principalTable: "Likes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ArticleReactions_Supports_SupportId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ArticleReads_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CommentReactions_DisLikes_DisLikeId",
                        column: x => x.DisLikeId,
                        principalTable: "DisLikes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CommentReactions_Likes_LikeId",
                        column: x => x.LikeId,
                        principalTable: "Likes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CommentReactions_Supports_SupportId",
                        column: x => x.SupportId,
                        principalTable: "Supports",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ArticleReactions_DisLikeId",
                table: "ArticleReactions",
                column: "DisLikeId",
                unique: true,
                filter: "[DisLikeId] IS NOT NULL");

            migrationBuilder.CreateIndex(
                name: "IX_ArticleReactions_LikeId",
                table: "ArticleReactions",
                column: "LikeId",
                unique: true,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ArticleReactions_SupportId",
                table: "ArticleReactions",
                column: "SupportId",
                unique: true,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CommentReactions_DisLikeId",
                table: "CommentReactions",
                column: "DisLikeId",
                unique: true,
                filter: "[DisLikeId] IS NOT NULL");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CommentReactions_LikeId",
                table: "CommentReactions",
                column: "LikeId",
                unique: true,
                filter: "[LikeId] IS NOT NULL");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CommentReactions_SupportId",
                table: "CommentReactions",
                column: "SupportId",
                unique: true,
                filter: "[SupportId] IS NOT NULL");
